...
*Method selected based on target platform. See `resources/persona-encoding-guide.md` for full guidance on all methods.*
...
*For advanced encoding patterns (Custom Metadata, Conversation Style, Global Topic Override), see `resources/persona-encoding-guide.md`.*
