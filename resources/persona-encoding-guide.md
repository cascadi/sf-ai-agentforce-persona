...
**How many terms?** 5-15 per topic is the productive range. Below 5, the lexicon isn't doing much work. Above 15, diminishing returns — the model starts over-using jargon. If you have 20+ terms, split into subtopics or move the less critical ones to global lexicon.
...
**Persona reminders** — **always include a persona reminder in every topic instruction.** Reminders reference back to the global persona and are the most effective tool for mitigating drift in longer sessions. Empirical testing confirms that persona reminders in topic instructions produce measurably stronger persona consistency than relying on global instructions alone:
...
topic [topic_name]:
  ...
  reasoning:
    instructions: ->
      [Per-topic calibration: brevity, tone flex, lexicon,
