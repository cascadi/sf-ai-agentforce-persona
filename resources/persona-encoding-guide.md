...
5. **Error message** — Fallback message for system errors. Should reflect Voice + Tone + Brevity — same guidance as the Agent Builder Error Message field.
